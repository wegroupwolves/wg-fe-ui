...
describe('ToggleButton', () => {
  it('When disabled, button is unclickable & color changed', () => {
    ...
    const wrapperEnabled = shallow(
      <ToggleButton onClick={() => value++}>Testje1</ToggleButton>,
    );
    ...
    const wrapperDisabled = shallow(
      <ToggleButton disabled onClick={() => value++}>
        Testje2
      </ToggleButton>,
    );
  ...
  it('style changes when level changes', () => {
    ...
    wrapper.setProps({
      children: (
        <ToggleButton level="active" onClick={() => console.log('test')}>
          Testje2
        </ToggleButton>
      ),
    });
  ...
  it('fullwidth prop takes 100% of width', () => {
    const wrapper = mount(
      <ToggleButton fullwidth onClick={() => console.log('testen')}>
        Testje
      </ToggleButton>,
    );
