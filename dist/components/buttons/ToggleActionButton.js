...
var ToggleActionButton = function ToggleActionButton(_ref) {
...
var StyledButton = _styledComponents.default.button(_templateObject(), (0, _styledTheme.key)('fonts.primary'), function (props) {
  return props.disabled ? (0, _styledTheme.key)('colors.disabled') : props.level === 'active' ? (0, _styledTheme.key)('colors.toggle') : (0, _styledTheme.key)('colors.interactive');
}, (0, _styledTheme.key)('fonts.normal-size'), function (props) {
  return props.fullwidth ? '100%' : '';
}, function (props) {
  return props.level === 'active' ? '' : (0, _styledTheme.key)('colors.hover');
});
...
var _default = ToggleActionButton;
